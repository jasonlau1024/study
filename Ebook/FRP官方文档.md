...
dashboard_port = 7500
dashboard_user = admin
dashboard_pwd = sfassjaflas
#vhost_http_port = 38888
...
# 指定 FRPS 地址和端口以及认证Token
server_addr = 0.0.0.0
server_port = 7000
token = 12345678

# 通过 http代理或socks5 或 FRPS 通信
http_proxy = http://user:passwd@192.168.1.128:8080
http_proxy = socks5://user:passwd@192.168.1.128:1080

# 指定日志文件、日志等级(trace, debug, info, warn, error)、保存天数
log_file = ./frpc.log
log_level = info
log_max_days = 3
disable_log_color = false
...
# 开启 TCP 多路复用，FRPS需同时开启
tcp_mux = true

# 显示的代理名称
user = your_name

# 首次登录失败退出程序（否则继续重新连接FRPS）
login_fail_exit = true

# 与 FRPS 通信的协议，支持TCP KCP WebSocket
protocol = tcp
...
# 心跳配置，heartbeat_interval 默认10 ，heartbeat_timeout 默认 90
